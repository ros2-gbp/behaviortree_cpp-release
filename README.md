...
## behaviortree_cpp_v3 (rolling) - 3.8.6-1

The packages in the `behaviortree_cpp_v3` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling behaviortree_cpp_v3 -y` on `Tue, 19 Dec 2023 08:31:11 -0000`
...
## behaviortree_cpp_v3 (iron) - 3.8.6-1

The packages in the `behaviortree_cpp_v3` repository were released into the `iron` distro by running `/usr/bin/bloom-release --rosdistro iron behaviortree_cpp_v3 -y` on `Tue, 19 Dec 2023 08:28:07 -0000`
...
## behaviortree_cpp_v3 (iron) - 3.8.5-1

The packages in the `behaviortree_cpp_v3` repository were released into the `iron` distro by running `/usr/bin/bloom-release --rosdistro iron behaviortree_cpp_v3 -y` on `Mon, 14 Aug 2023 08:39:30 -0000`
...
## behaviortree_cpp_v3 (iron) - 3.8.4-1

The packages in the `behaviortree_cpp_v3` repository were released into the `iron` distro by running `/usr/bin/bloom-release --ros-distro iron behaviortree_cpp_v3 -y` on `Wed, 28 Jun 2023 21:13:25 -0000`
...
## behaviortree_cpp_v3 (rolling) - 3.8.4-1

The packages in the `behaviortree_cpp_v3` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling behaviortree_cpp_v3 -y` on `Wed, 28 Jun 2023 21:05:08 -0000`
...
## behaviortree_cpp_v3 (rolling) - 3.8.3-2

The packages in the `behaviortree_cpp_v3` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling behaviortree_cpp_v3 -y` on `Wed, 01 Mar 2023 21:22:55 -0000`
...
## behaviortree_cpp_v3 (rolling) - 3.8.3-1

The packages in the `behaviortree_cpp_v3` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling behaviortree_cpp_v3 -y` on `Wed, 01 Mar 2023 20:07:24 -0000`
...
The packages in the `behaviortree_cpp_v3` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling behaviortree_cpp_v3 -e` on `Thu, 12 Jan 2023 11:36:31 -0000`
...
## behaviortree_cpp (humble) - 3.8.0-1

The packages in the `behaviortree_cpp` repository were released into the `humble` distro by running `/usr/bin/bloom-release behaviortree_cpp --rosdistro humble -y` on `Tue, 11 Oct 2022 10:12:30 -0000`
...
## behaviortree_cpp (rolling) - 3.8.0-1

The packages in the `behaviortree_cpp` repository were released into the `rolling` distro by running `/usr/bin/bloom-release behaviortree_cpp --rosdistro rolling -y` on `Tue, 11 Oct 2022 10:09:10 -0000`
...
## behaviortree_cpp (galactic) - 3.8.0-1

The packages in the `behaviortree_cpp` repository were released into the `galactic` distro by running `/usr/bin/bloom-release behaviortree_cpp --rosdistro galactic -y` on `Tue, 11 Oct 2022 09:58:36 -0000`
...
## behaviortree_cpp (rolling) - 3.6.0-1

The packages in the `behaviortree_cpp` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling behaviortree_cpp -y` on `Thu, 11 Nov 2021 15:03:02 -0000`
...
## behaviortree_cpp (galactic) - 3.6.0-1

The packages in the `behaviortree_cpp` repository were released into the `galactic` distro by running `/usr/bin/bloom-release --rosdistro galactic behaviortree_cpp` on `Wed, 10 Nov 2021 09:28:10 -0000`
